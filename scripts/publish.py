...
def main():
    ...
    parser.add_argument("--build-only", action="store_true", help="Only build packages, don't publish")
    parser.add_argument("--test-install", action="store_true", help="Test installation after publishing")
    ...
    print("  conda install -c conda-forge ultrafast-client  # (if conda package is created)")
